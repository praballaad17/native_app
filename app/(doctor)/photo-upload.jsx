  ...
  return (
    ...
    <SafeAreaView className="h-full">
      <ScrollView>
        ...
        <Text>PhotoUpload</Text>
            ...
            {/* Conditionally render the image or error message */}
                {file ? (
                    ...
                    <View >
                        <Text>Image:</Text>
                        <Image  resizeMode='contain' className="w-full h-[65vh]"
                        source={{ uri: file }}
                            />
                    </View>
                ) : (
        ...
        <CustomButton 
            title={"Select"} handlePress={pickImage} containerStyles="mt-7" isLoading={isSubmitting} />
        
        <CustomButton 
            title={"Upload"} handlePress={submit} containerStyles="mt-1" isLoading={isSubmitting} />
         <CustomButton 
            title={"Cancel"} handlePress={() => {}} containerStyles="mt-1" isLoading={isSubmitting} />
